							...
							<div class="col-lg-4 col-md-4">
								<div class="car__item">
									<div class="car__item__pic__slider owl-carousel">
										<a href="<c:url value="/AddCart/id=${product.id }"/>"><img src="${product.getImg()}" alt=""></a> <img
											src="resources/img/cars/car-3.jpg" alt=""> <img
											src="resources/img/cars/car-5.jpg" alt=""> <img
											src="resources/img/cars/car-2.jpg" alt=""> <img
											src="resources/img/cars/car-1.jpg" alt=""> <img
											src="resources/img/cars/car-8.jpg" alt=""> <img
											src="resources/img/cars/car-6.jpg" alt="">
									...
									<div class="car__item__text">
										<div class="car__item__text__inner">
											...
											<h5>
												<a href="<c:url value='/product/id=${product.id}'/>">${product.getTitle()}</a>
											</h5>
											<ul>
												<li><span><fmt:formatNumber
															value="${product.getMi()}" type="number"
															maxIntegerDigits="14" /></span> mi</li>
												<li>${product.getAuto()}</li>
												<li><span><fmt:formatNumber
															value="${product.getHp()}" type="number"
															maxIntegerDigits="14" /></span> hp</li>
											</ul>
										</div>
										<div class="car__item__price">
											<h5>
												<a href="<c:url value="/AddCart/id=${product.id }"/>"> <span
													class="car-option ">Cho Thuê</span></a>
											</h5>
											<h6>
								...
								<div class="car__item">
									...
									<div class="car__item__text">
										...
										<div class="car__item__price">
											<h5>
												<a href="<c:url value="/AddCart/id=${product.id }"/>"> <span
													class="car-option sale">Bán</span></a>
											</h5>
											<h6>
												<fmt:formatNumber value="${product.getPrice()}"
													type="number" maxIntegerDigits="14" />
