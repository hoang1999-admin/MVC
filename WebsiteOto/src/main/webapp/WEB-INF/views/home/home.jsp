...
<body>
    ...
    <!-- Hero Section Begin -->
   <jsp:include page="/WEB-INF/views/home/Hero.jsp"></jsp:include>
    <!-- Hero Section End -->

    <!-- Services Section Begin -->
    <jsp:include page="/WEB-INF/views/home/Services.jsp"></jsp:include>
    <!-- Services Section End -->

    <!-- Feature Section Begin -->
    <jsp:include page="/WEB-INF/views/home/Feature.jsp"></jsp:include>
    <!-- Feature Section End -->

    <!-- Car Section Begin -->
    <jsp:include page="/WEB-INF/views/home/Car.jsp"></jsp:include>
    <!-- Car Section End -->

    <!-- Chooseus Section Begin -->
    <jsp:include page="/WEB-INF/views/home/Chooseus.jsp"></jsp:include>
    <!-- Chooseus Section End -->

    <!-- Latest Blog Section Begin -->
    <jsp:include page="/WEB-INF/views/home/Latest_Blog.jsp"></jsp:include>
    <!-- Latest Blog Section End -->

    <!-- Cta Begin -->
    <jsp:include page="/WEB-INF/views/home/Cta.jsp"></jsp:include>
    <!-- Cta End -->
